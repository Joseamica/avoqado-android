...
object TextosMerma {
    ...
    const val NO_SE_PUDO_REGISTRAR = "No se pudo registrar {articulos}: revísala en «Mermas por subir»."
    const val NO_SE_PUDIERON_REGISTRAR = "No se pudieron registrar {articulos}: revísalas en «Mermas por subir»."
    ...
    const val HISTORIAL_CAMBIO = "La lista cambió mientras la leías."
